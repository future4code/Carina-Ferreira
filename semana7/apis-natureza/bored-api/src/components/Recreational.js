...
export class Reacreational extends React.Component {
    state = {
        activity: {}
      }
  ...
  render() {
    ...
    return (
      <div>
        <EstiloBotao2 onClick = {this.props.voltarParaPaginaInicial3}> Voltar</EstiloBotao2>
        <P>Para gerar uma atividade de recreação, clique no botão abaixo:</P>
        <EstiloBotao onClick = {this.getActivityType}>Gerar atividade</EstiloBotao>
        <H3>Atividade de Recreação:</H3>
