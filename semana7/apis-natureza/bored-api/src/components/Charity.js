...
export class Charity extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <EstiloBotao2 onClick = {this.props.voltarParaPaginaInicial4}> Voltar</EstiloBotao2>
        <P>Para gerar uma atividade de caridade, clique no botão abaixo:</P>
        <EstiloBotao onClick = {this.getActivityType}>Gerar atividade</EstiloBotao>
        <H3>Atividade de Caridade:</H3>
