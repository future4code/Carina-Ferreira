...
export class Cooking extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <EstiloBotao2 onClick = {this.props.voltarParaPaginaInicial5}> Voltar</EstiloBotao2>
     
        <P>Para gerar uma atividade de culinária, clique no botão abaixo:</P>
        <EstiloBotao onClick = {this.getActivityType}>Gerar atividade</EstiloBotao>
        <H3>Atividade de Culinária:</H3>
        <DivAtividade>
